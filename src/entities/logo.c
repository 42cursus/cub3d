...
/*   Updated: 2025/06/04 20:36:25 by fsmyth           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	spawn_logo_piece(t_info *app, t_vect pos, t_vect dir, t_texture *texture)
{
	...
	logo_piece->pos = subtract_vect(pos, scale_vect(dir, 60));
...
{
	if (vector_distance(obj->pos, obj->end_pos) > 0.01)
